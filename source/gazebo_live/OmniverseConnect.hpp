...
#ifndef GZ_OMNIVERSE_CONNECT_HPP
#define GZ_OMNIVERSE_CONNECT_HPP
...
/// \brief Creates a new gz stage in omniverse, does nothing if the
/// stage already exists.
/// \details The new stage is authored with gz metadata.
